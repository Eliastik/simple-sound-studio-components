                ...
                <div className="flex join">
                    {filter.hasSettings &&
                        <button
                            ...
                            onClick={() => filter.settingsForm && (document.getElementById(`modalSettings_${filter.filterId}`) as HTMLDialogElement).showModal()}
                        >
                    ...
                    <button
                        ...
                        onClick={() => (document.getElementById(`modalInfos_${filter.filterId}`) as HTMLDialogElement).showModal()}
                    >
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
